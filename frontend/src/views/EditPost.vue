<template>
  <div>
    <div class="bg-white shadow-lg rounded px-8 pt-6 pb-8 border mb-4 md:mx-10 mx-2 flex flex-col center ">
      <h2 class="text-center py-3 mb-2 uppercase text-4xl font-black text-gray-800">Edit Post
      </h2>
  ...
  methods: {
    async updatePost() {
      if (this.title && this.content) {
        this.feedback = null;
        await PostService.updatePost(this.post._id, this.title, this.content);
